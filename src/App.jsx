...
const LabsLandingPage = () => {
  const labs = [
    ...
    //   images: [
    //     `src/assets/mechanical_workshop_1.jpg`,
    //     `src/assets/mechanical_workshop_2.jpg`,
    //     `src/assets/mechanical_workshop_3.jpg`
    //   ]
    // },
    {
      ...
      images: [
        `src/assets/material_testing_lab_1.jpg`,
        `src/assets/material_testing_lab_2.png`,
        `src/assets/material_testing_lab_3.png`,
        `src/assets/material_testing_lab_4.png`,
        `src/assets/material_testing_lab_5.png`,
        `src/assets/material_testing_lab_6.png`,
        `src/assets/material_testing_lab_7.png`,
        `src/assets/material_testing_lab_8.png`,
        `src/assets/material_testing_lab_9.png`,
        `src/assets/material_testing_lab_10.png`,
        `src/assets/material_testing_lab_11.png`,
        `src/assets/material_testing_lab_12.png`,
        `src/assets/material_testing_lab_13.png`
      ]
    },
    // {
    ...
    //   images: [
    //     `src/assets/mechanics_of_machines_lab_1.jpg`,
    //     `src/assets/mechanics_of_machines_lab_2.jpg`,
    //     `src/assets/mechanics_of_machines_lab_3.jpg`
    //   ]
    // },
    {
      ...
      images: [
        `src/assets/heat_transfer_lab_1.jpg`
      ]
    },
    {
      title: "Metrology Lab",
      ...
      images: [
        `src/assets/metrology_lab_1.jpg`,
      ]
    },
    {
      ...
      images: [
        `src/assets/hydraulics_lab_1.jpg`,
        `src/assets/hydraulics_lab_2.jpg`,
        `src/assets/hydraulics_lab_3.jpg`,
        `src/assets/hydraulics_lab_4.jpg`,
        `src/assets/hydraulics_lab_5.jpg`,
        `src/assets/hydraulics_lab_6.jpg`,
        `src/assets/hydraulics_lab_7.jpg`,
        `src/assets/hydraulics_lab_8.jpg`,
      ]
    },
    {
      ...
      images: [
        `src/assets/fluid_mechanics_lab_1.jpg`,
        `src/assets/fluid_mechanics_lab_2.jpg`,
        `src/assets/fluid_mechanics_lab_3.jpg`,
        `src/assets/fluid_mechanics_lab_4.jpg`,
        `src/assets/fluid_mechanics_lab_5.jpg`,
        `src/assets/fluid_mechanics_lab_6.jpg`,
        `src/assets/fluid_mechanics_lab_7.jpg`,
        `src/assets/fluid_mechanics_lab_8.jpg`,
      ]
    },
    {
      ...
      images: [
        `src/assets/automobile_lab_1.jpg`,
        `src/assets/automobile_lab_2.jpg`,
        `src/assets/automobile_lab_3.jpg`,
        `src/assets/automobile_lab_4.jpg`, 
        `src/assets/automobile_lab_5.jpg`,
        `src/assets/automobile_lab_6.jpg`,
        `src/assets/automobile_lab_7.jpg`,
        `src/assets/automobile_lab_8.jpg`,
        `src/assets/automobile_lab_9.jpg`,
        `src/assets/automobile_lab_10.jpg`,
        `src/assets/automobile_lab_11.jpg`,
        `src/assets/automobile_lab_12.jpg`,
        `src/assets/automobile_lab_13.jpg`
      ]
    },
    {
      title: "Thermal Lab",
    ...
    //   images: [
    //     `src/assets/material_science_lab_1.jpg`,
    //     `src/assets/material_science_lab_2.jpg`,
    //     `src/assets/material_science_lab_3.jpg`
    //   ]
    // },
    {
      ...
      images: [
        `src/assets/manufacturing_science_lab_1.jpg`,
        `src/assets/manufacturing_science_lab_2.jpg`,
        `src/assets/manufacturing_science_lab_3.jpg`
      ]
    },
    {
      ...
      images: [
        `src/assets/refrigeration_and_air_conditioning_lab_1.jpg`,
        `src/assets/refrigeration_and_air_conditioning_lab_2.jpg`,
        `src/assets/refrigeration_and_air_conditioning_lab_3.jpg`,
        `src/assets/refrigeration_and_air_conditioning_lab_4.jpg`,
        `src/assets/refrigeration_and_air_conditioning_lab_5.jpg`,
        `src/assets/refrigeration_and_air_conditioning_lab_6.jpg`,
        `src/assets/refrigeration_and_air_conditioning_lab_7.jpg`,
        `src/assets/refrigeration_and_air_conditioning_lab_8.jpg`,
        `src/assets/refrigeration_and_air_conditioning_lab_9.jpg`
      ]
    },
    // {
    //   title: "SQC & IE Lab",
    ...
    //   images: [
    //     `src/assets/sqc_ie_lab_1.jpg`,
    //     `src/assets/sqc_ie_lab_2.jpg`,
    //     `src/assets/sqc_ie_lab_3.jpg`
    //   ]
    // }
  ];
